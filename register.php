                ...
                <div class="offset-lg-2 col-lg-8">
                    <form action="" method="POST" class="form-contact contact_form">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input onkeypress='validate(event)' class="form-control" name="rno" id="rno" type="tel" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Registraion Number'" placeholder="Registration Number (Type 00 for Faculty/Staff)" required title="Please Enter Valid Registration Number">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
